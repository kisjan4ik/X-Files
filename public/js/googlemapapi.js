...
"use strict";
// declare some constants for maps information
var locations = [];
let map;
var alien = "/images/aliensmaller.png";
var marker, i;

// function to load the initial map containing any sightings since 2014
function startPage() {
  $.ajax({
    url: "/api/sightings",
    method: "GET"
  }).then(function (data) {
    // loop to determine the year of the data and put data since 2014 into the location array
    ...
    // call the map api element and center it on the us
    ...
    // loop to input the locations array information into markers on the map
    for (let i = 0; i < locations.length; i++) {
      ...
      // listener to pull up information about the sighting on marker click and close any othe infowindows open
...
// similar function to handle the state specific search
...
// click function to initiate state search
